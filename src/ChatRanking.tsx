                ...
                <table className="w-full text-sm" style={{ fontFamily: "var(--font-yui)" }}>
                    <thead>
                        <tr className="text-[#444]">
                            <th className="py-1 px-2 font-bold whitespace-nowrap border-b border-[#d2b48c]">おなまえ</th>
                            <th className="py-1 px-2 font-bold whitespace-nowrap border-b border-[#d2b48c]">発言回数</th>
                            <th className="py-1 px-2 font-bold whitespace-nowrap border-b border-[#d2b48c]">最終発言時刻</th>
                            <th className="py-1 px-2 font-bold whitespace-nowrap border-b border-[#d2b48c]">ホスト情報</th>
                        </tr>
                    </thead>
                    <tbody>
                        {ranking.length === 0 && (
                        ...
                        {ranking.map(({ name, count, lastTime }) => (
                            <tr key={name}>
                                ...
                                <td className="py-1 px-2 border-b border-[#e9d7ba] text-center">{formatCountTime(lastTime)}</td>
                                <td className="py-1 px-2 border-b border-[#e9d7ba] text-xs text-gray-400 text-center">-</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
