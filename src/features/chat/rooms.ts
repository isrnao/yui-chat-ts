...
const ROOM_DESCRIPTIONS: Record<RoomId, string> = {
  ...
  elementary:
    '小学生のためのおしゃべり部屋です。学校での出来事や流行りの遊び、ゲームの話題まで、同世代の友達と安心して楽しくお話しできます。宿題の息抜きにもどうぞ。',
  juniorhighschool:
  ...
  '10generations':
    '10代限定の話題で盛り上がる部屋です。学校や友達関係、流行りの音楽や動画の話など、同じ時代を生きる10代同士だからこそ通じる話題を楽しめます。',
  '20generations':
  ...
  shouchu:
    '小学生・中学生のための歴史ある部屋です。学校の話題や好きな遊びの話など、同世代同士で安心して話せます。放課後の待ち合わせ場所のようにどうぞ。',
  '20dai':
  ...
  '2shot':
    '二人きりで話す2ショットチャットの文化を再現した部屋です。じっくり一対一で話したい相手との待ち合わせや、静かな会話をしたい時に向いています。',

  com_sb:
    '管理者への連絡や相談のための部屋です。サイトの不具合報告やご要望、運営に伝えたいことがある時は、こちらの部屋で気軽にお知らせください。荒らしの報告もこちらへどうぞ。',
