...
describe('useChatRanking', () => {
  ...
  it('should filter out system messages and messages without name', () => {
    const chatLog: Chat[] = [
      { id: '1', name: '', color: '#000', message: 'test', time: 100 },
      { id: '2', name: 'User1', color: '#000', message: 'test', time: 200, system: true },
      { id: '3', name: 'User2', color: '#000', message: 'test', time: 300 },
    ];
  ...
  it('should count messages per user', () => {
    const chatLog: Chat[] = [
      { id: '1', name: 'User1', color: '#000', message: 'test1', time: 100 },
      { id: '2', name: 'User2', color: '#000', message: 'test2', time: 200 },
      { id: '3', name: 'User1', color: '#000', message: 'test3', time: 300 },
      { id: '4', name: 'User1', color: '#000', message: 'test4', time: 400 },
    ];
  ...
  it('should sort by count descending, then by lastTime descending', () => {
    const chatLog: Chat[] = [
      { id: '1', name: 'User1', color: '#000', message: 'test1', time: 100 }, // count: 1, lastTime: 100
      { id: '2', name: 'User2', color: '#000', message: 'test2', time: 200 }, // count: 2, lastTime: 300
      { id: '3', name: 'User3', color: '#000', message: 'test3', time: 400 }, // count: 2, lastTime: 500
      { id: '4', name: 'User2', color: '#000', message: 'test4', time: 300 },
      { id: '5', name: 'User3', color: '#000', message: 'test5', time: 500 },
    ];
  ...
  it('should update ranking when chat log changes', () => {
    ...
    const updatedChatLog: Chat[] = [
      ...initialChatLog,
      { id: '2', name: 'User2', color: '#000', message: 'test2', time: 200 },
      { id: '3', name: 'User2', color: '#000', message: 'test3', time: 300 },
    ];
  ...
  it('should handle users with same count and same lastTime', () => {
    const chatLog: Chat[] = [
      { id: '1', name: 'User1', color: '#000', message: 'test1', time: 100 },
      { id: '2', name: 'User2', color: '#000', message: 'test2', time: 100 },
    ];
  ...
  it('should track lastTime correctly for multiple messages from same user', () => {
    const chatLog: Chat[] = [
      { id: '1', name: 'User1', color: '#000', message: 'test1', time: 100 },
      { id: '2', name: 'User1', color: '#000', message: 'test2', time: 50 }, // 古い時間
      { id: '3', name: 'User1', color: '#000', message: 'test3', time: 200 }, // 最新時間
    ];
  ...
  it('should handle empty names correctly', () => {
    const chatLog: Chat[] = [
      { id: '1', name: '', color: '#000', message: 'test1', time: 100 },
      { id: '2', name: null as any, color: '#000', message: 'test2', time: 200 },
      { id: '3', name: undefined as any, color: '#000', message: 'test3', time: 300 },
      { id: '4', name: 'ValidUser', color: '#000', message: 'test4', time: 400 },
    ];
  ...
  it('should handle mixed system and regular messages', () => {
    const chatLog: Chat[] = [
      { id: '1', name: 'User1', color: '#000', message: 'regular', time: 100 },
      { id: '2', name: 'System', color: '#000', message: 'system msg', time: 200, system: true },
      { id: '3', name: 'User1', color: '#000', message: 'another regular', time: 300 },
      { id: '4', name: 'User2', color: '#000', message: 'regular2', time: 400, system: false },
    ];
